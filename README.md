...
**막연한 요청을 gpt-image-2 완성 프롬프트로 컴파일하는 Claude Code 스킬.**

"포스터 하나 만들어줘" 같은 거친 한마디를, 바로 생성에 넣을 수 있는 완성 한국어 프로덕션 프롬프트로 바꾼다. 1,000장 규모 라이브러리·화보·포스터·만화를 뽑으며 정립한 규칙을 한 스킬로 묶었다.

> 데모: **https://kimsh-1.github.io/image-prompt-kit**
